define('resolver',['require','exports','module'],function(require, exports, module){
  "use stict"
  var re = /include\(['"]([\/\d\w\-\.]+)['"].*\)/;
...
define('text!view/index.tp',[],function () { return '<h1>HELLO WORLD</h1>\n\n<ul>\n  <?for(let i = 0, len = this.list.length; i < len; i++){?>\n    <?= this.include(\'view/item.tp\', this.list[i])?>\n  <?}?>\n</ul>\n';});


define('text!view/item.tp',[],function () { return '<li>\n  <a><?=this.name?></a>\n  <time><?=this.date?></time>\n</li>\n\n';});
